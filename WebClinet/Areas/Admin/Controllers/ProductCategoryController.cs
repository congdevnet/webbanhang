...
namespace WebClinet.Areas.Admin.Controllers
{
    public class ProductCategoryController : BaseController
    {
        ...
        public ProductCategoryController(IProductCategoryService NewService)
        ...
        [HttpPost]
        public async Task<JsonResult> Add(ProductCategoryViewModel NewView)
        {
            if (!ModelState.IsValid)
            {
                return null;
            }
            if (NewView.CategoryID < 1)
            {
